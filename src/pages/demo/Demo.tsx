...
import { InfoBox, Modal, DateRange } from "../../core/components";
...
export const Demo: FC<Props> = ({}) => {
  ...
  const [dateRange, setDateRange] = React.useState(
    () => [moment(), moment().add(4, "day")] as const
  );
  ...
  const [radioState, setRadioState] = React.useState<"foo" | "bar" | "baz">(
    "bar"
  );
  const [status, setStatus] = React.useState<"All" | "Healthy" | "Offline">(
    "All"
  );
  ...
  return (
    <div className="max-w-screen-lg m-auto">
      <div className="mt-5 flex">
        <div className="w-28 self-center text-center mr-5 flex-shrink-0">
          COLORS
        </div>
        <div className="flex">
          ...
          <div className="ml-2 w-24 h-24 bg-clear-white relative border border-black border-solid">
            <div className="absolute text-gray-600 bottom-1 left-2">
              #FAFAFA
            </div>
          </div>
        </div>
      ...
      <div className="mt-10 flex">
        ...
        <Button className="ml-3" red>
          Destructive Action
        </Button>
        <Button className="ml-3" disabled>
          Disabled Button
        </Button>
        <Button className="ml-3" secondary>
          Secondary Button
        </Button>
      </div>
      <div className="mt-10 flex">
      ...
      <div className="mt-10 flex">
        ...
        <div className="flex-grow flex flex-wrap -m-5">
          ...
          />
          <TextBox
            prependIcon="fas fa-envelope-open"
            className="w-60 m-5"
          ...
          />
          <TextBox
            prependIcon="text-lg icon-48_Search"
            className="w-60 m-5"
            placeholder="required"
            label="E-mail Address"
            defaultValue=""
          />
          <TextBox
            appendIcon="text-lg icon-36_Send"
            className="w-60 m-5"
            placeholder="required"
            label="E-mail Address"
            defaultValue="atesh@veea.com"
      ...
      <div className="mt-10 flex">
        ...
        <div className="flex-grow flex flex-col">
          ...
          />
          <DateRange
            className="flex-grow max-w-xl mt-10"
            value={dateRange}
            onChange={setDateRange}
          />
        </div>
        ...
        <div className="flex-grow flex flex-col items-start">
          ...
          <Section
            ...
            infoLink={{
              ...
              text: (
                <>
                  Feed your cat and press{" "}
                  <span className="pre font-mono ">P</span>
                </>
              ),
            }}
          >
      ...
      <div className="mt-10 flex">
        ...
        <div className="flex-grow flex flex-col items-start">
          <label>
            <Checkbox className="mr-2" value={toggle1} onChange={setToggle1} />I
            agree to the Veea Terms of Service
          </label>
          <div className="mt-5">
            <Checkbox
              className="mr-2"
      ...
      <div className="mt-10 flex">
        ...
        <div className="flex-grow flex flex-wrap items-start -m-3">
          <InfoBox className="m-3" kind="error">
            Invalid e-mail or password
          </InfoBox>
          <InfoBox className="m-3" kind="warn" onClose={() => {}}>
            Changing this setting might break things
          </InfoBox>
          <InfoBox className="m-3" kind="success">
            Cat added to database successfully
          </InfoBox>
          <InfoBox className="m-3">
            I am just a tip, do whatever you want
          </InfoBox>
      ...
      <div className="mt-10 flex">
        ...
        <div className="flex-grow flex flex-wrap items-start">
          <Button className="mr-3" onClick={() => setModal1Open(true)}>
            Open Modal
          </Button>
